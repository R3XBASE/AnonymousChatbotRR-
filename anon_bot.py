...
BOT_TOKEN = os.getenv("BOT_TOKEN")  # Atau 'YOUR_BOT_TOKEN' untuk lokal
WEBHOOK_URL = os.getenv("WEBHOOK_URL")  # e.g., https://your-app.com/webhook
...
def next_match(user_id):
    try:
        ...
        partner_id = partner_row[0] if partner_row else None  # Fix: fetchone() returns tuple (partner_id,)
...
# Health check endpoint (untuk deploy platform)
@app.route('/')
def index():
...
if __name__ == '__main__':
    ...
    # Run Flask (lokal: port 5000; prod: gunicorn handle)
